...
The next permitted scientific task is **S00 — Source Audit**.
...
> Read `docs/qahbn2/00_QAHBN2_MASTER.md`, `01_CANONICAL_AHBN_CONTRACT.md`, and the current stage `.md` file before doing anything else.
>
